...
nr_beat_bins = 3
percus_push_factor = 25.       # How much does a percussive beat push the perceptual change
base_decay = 0.20              # How slowely does a 'base-push' decay back to zero
...
def create_audio_features(audio_path, verbose = 0):
  ...
  treble[treble < percussive_threshold] = 0
  final_percus_features[1,:] = treble

  #### SNARE ####
  snare = final_percus_features[-1,:]
  snare[snare < percussive_threshold] = 0
  ...
  base[base<percussive_threshold] = 0
  #base = base**2
