...
lora_prompts = [
        'low poly artwork of <concept>, svg',
        'a photo of <concept>, high quality professional photography, nikon d850 50mm',
        'a photo of a massive statue of <concept> in the middle of the city',
        '<concept> in pixel art, 8-bit video game style',
        'painting of <concept> by Vincent van Gogh',
        'origami paper sculpture of <concept>',
        ...
        '<concept> sand sculpture at the beach',
        '<concept> as a statue made of marble',
        '<concept> as an action figure superhero, lego toy, toy story',
        '<concept> carved into the side of a mountain, intricate rock formation',
        ...
        '<concept> starring in a classic black and white silent film',
        'a graffiti art of <concept> on the walls of an urban alley',
        'watercolor portrait of <concept>, brushed with soft pastels',
        'an intricate wood carving of <concept> in a historic temple',
        'a retro 90s cartoon version of <concept>, VHS tape quality',
        '<concept> featured on a vintage cereal box, complete with a "free toy inside" label',
        ...
        'a graffiti mural of <concept> on a brick wall, neon colors, urban style',
        '<concept> as a topiary in a grand garden maze, pristinely cut hedge',
        'a tattoo design of <concept>, tribal ink on an arm with intricate patterns surrounding',
        '<concept> on the cover of a classic rock album, amidst electric guitars and stage lights',
        '<concept> as a retro holographic sticker, shimmering in bright colors',
        'a pop-up book scene of <concept>, where pulling a tab makes him dance',
        '<concept> as a bobblehead on a car dashboard, nodding incessantly',
        'a hand-crafted marionette puppet of <concept>, strings and all, performing in a show',
        '<concept> as a character in an old silent film, black and white, exaggerated actions',
        'a chalk art rendition of <concept> on the sidewalk, from a childs perspective',
        'a sand sculpture of <concept> on a beach, complete with shells and seaweed details',
        '<concept> as a mascot on a retro roller skating rink ticket, with disco lights in the background',
        'a jigsaw puzzle where the main image is <concept>, 1000 pieces of fun',
        '<concept> transformed into a constellation in the night sky, guiding sailors at sea',
        '<concept> having a birthday party, cake and balloons',
        'intricate wood carving of <concept>',
        "a photo of <concept> climbing mount Everest, stunning views, setting sun, high quality professional photography, nikon d850 50mm",
        "a polaroid photograph of <concept> chilling in a hot tub, smoking a big cigar",
        "an stunning artwork depicting <concept> as a god, radiant and mighty, towering high in the skies",
        "a photo of a massive <concept> monument in an ancient city in the Mexican jungle, thousands are worshipping",
        "A high-resolution photo of <concept> standing at the edge of the Grand Canyon during a vibrant sunset, with vast, colorful layers of rock stretching into the distance."
        "A photorealistic image of <concept> diving with a school of radiant, bioluminescent jellyfish in the deep blue ocean, under the shimmering moonlight.",
        "A detailed photograph of <concept> in a hot air balloon, floating over the lavender fields of Provence, France, with the golden sunrise casting a warm glow.",
        "A crisp, clear photo of <concept> witnessing the Northern Lights in Iceland, standing on a snow-covered field with the vivid aurora borealis in the sky.",
        "A realistic photo of <concept> hiking in the lush, green Amazon rainforest, surrounded by exotic wildlife and ancient trees, with a distant waterfall.",
        "A photorealistic depiction of <concept> at the peak of Mount Kilimanjaro, with a breathtaking view of the African plains and clouds below at dawn.",
        "A high-definition photo of <concept> in a glass igloo, watching the starry night sky in Finnish Lapland, surrounded by a serene, snowy landscape.",
        "A vivid photograph of <concept> walking through the colorful, narrow streets of Cinque Terre, Italy, with the Mediterranean Sea in the background.",
        "A lifelike photo of <concept> standing amidst the cherry blossoms in full bloom in Kyoto, Japan, with ancient temples and a serene river in the scene.",
        "A realistic image of <concept> on a gondola in Venice",
        "A photorealistic image of <concept> participating in an underwater tea party, surrounded by curious dolphins and colorful coral reefs, deep in the ocean.",
        "A high-quality photo of <concept> floating in a bubble above an active volcano, with vibrant lava flows and plumes of smoke creating a dramatic backdrop.",
        "A surreal photo of <concept> playing chess with intelligent robots on the surface of Mars, with the Earth visible in the Martian sky.",
        "A crisp, detailed photo of <concept> riding a glowing, neon-lit hoverboard through an ancient, abandoned city overrun by a lush, magical forest.",
        "A photorealistic depiction of <concept> conducting a symphony orchestra of various animals in an enchanted forest, with birds and creatures as the audience.",
        "A high-resolution image of <concept> exploring a crystal cave filled with luminous, otherworldly gems and reflecting pools under a distant alien sun.",
        "A detailed photograph of <concept> in a hot air balloon race through a sky filled with floating islands and mythical creatures soaring around them.",
        "A realistic photo of <concept> meditating at the edge of a cliff, with a gigantic, serene Buddha statue emerging from the clouds in the background.",
        "A photo of a massive <concept> monument, <concept> meditating like a serene Buddha on the top of a mountain, stunning panorama, setting sun",
        "A photo of a massive <concept> Buddha floating amidst white clouds, stunning panorama, setting sun",
        "A vivid image of <concept> navigating a raft on a neon, bioluminescent river in a futuristic cityscape, with skyscrapers towering above and casting reflections.",
        "A lifelike photo of <concept> participating in a midnight carnival parade on the moon, with astronauts and alien spectators cheering under the Earthlight.",
        "A photo of <concept> accidentally participating in a penguin parade, waddling along with a group of confused but welcoming penguins in Antarctica.",
        "A photorealistic image of <concept> in a chef's hat, frantically trying to cook in a kitchen where the utensils and ingredients are floating in zero gravity.",
        "A detailed photo of <concept> in a wild west duel, but instead of guns, they're armed with super soakers, facing a group of serious-looking cowboys.",
        "A high-resolution image of <concept> riding a unicycle in a crowded city, juggling brightly colored balls while being chased by a group of enthusiastic ducks.",
        "A photo of <concept> in an oversized astronaut suit, trying to chase after a runaway satellite on the moon, with a background of astronauts laughing.",
        "A photorealistic depiction of <concept> participating in a medieval joust, but instead of horses, they're riding on oversized, friendly tortoises.",
        "A realistic photo of <concept> trying to walk a group of enthusiastic, giant fluffy dogs in a park, getting tangled in a mess of leashes.",
        "A vivid image of <concept> in a detective outfit, investigating a 'crime' where the only culprits are mischievous cats in a cozy, chaotic living room.",
        "A lifelike photo of <concept> at a fashion show, modeling outrageously oversized hats while trying to navigate the runway without tripping.",
        "A detailed photograph of <concept> in a superhero costume, trying to fly but instead stuck in a tree, with amused onlookers and a cat smirking nearby.",
