...
def real2real_x(W, H, args, input_images, outdir, n, 
    ...
    post_process_audio_reactive_video_frames(frames_dir, audio_path, output_fps, n_film, audio_reactivity_settings)
...
if __name__ == "__main__":
    ...
    if 1: # debug: fast render settings
        H,W          = 512, 512
        n_imgs       = 2
        n_steps      = 20
        output_fps   = 12
