...
class Planner():
    ...
    """
    def __init__(self, audio_features_path, fps, total_frames):

        self.fps = fps
        self.frame_index = 0
        
        self.load_audio_features(audio_features_path)
    ...
    def load_audio_features(self, audio_features_path):
        self.harmonic_energy, self.final_percus_features, self.metadata = create_audio_features(audio_features_path)
